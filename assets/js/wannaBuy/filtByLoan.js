define(function(){
    ...
    var _id = {
        defaultSubmitBtn: 'submit-filt-load',
        customSubmitBtn: 'custom-submit-filt-load'
    };
    ...
    var _data = {
        ...
        validateCustomInputData: function(){
            ...
            if(((!regx.test(repaymentMin)&&repaymentMin!="")||(repaymentMin[0]=="."||repaymentMin[repaymentMin.length-1]==".")
                    ||(!regx.test(downpaymentMax)&&downpaymentMax!="")||(downpaymentMax[0]=="."||downpaymentMax[downpaymentMax.length-1]==".")
                    ||(!regx.test(downpaymentInput)&&downpaymentInput!="")||downpaymentInput[0]=="."||downpaymentInput[downpaymentInput.length-1]=="."))
            {
