define(['souche/custom-select'], function(CustomSelect, Select) {
            ...
            require(['souche/custom-select'], function(CustomSelect, Select) {
                ...
                var brandSeries = {
                    init: function() {
                        ...
                        this._bindBrandChange();
                        $.ajax({
                            url: contextPath + "/pages/dicAction/loadRootLevelJsonp.json",
                            dataType: "jsonp",
                            data: {
                    ...
                    _addSeries: function(brandCode) {
                        ...
                        $.ajax({
                            url: contextPath + "/pages/dicAction/loadRootLevelForCarJsonp.json",
                            dataType: "jsonp",
                            data: {
                                type: "car-subdivision",
                                code: brandCode
