...
define(function() {
    ...
    modelSeries.init = function () {
        var brandUrl = "http://localhost:8080/soucheweb/pages/dicAction/loadRootLevel.json?type=car-subdivision";
    ...
    modelSeries.GetSeries = function (brandCode,name) {
        var seriesUrl = "http://localhost:8080/soucheweb/pages/dicAction/loadRootLevelForCar.json?type=car-subdivision&code=" + brandCode;
        if (series[brandCode]) {
