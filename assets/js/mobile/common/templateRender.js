    ...
    init:function(){
        ...
        for(var i = 0;i<attributes.length;i++){
            ...
            if(regex_check.test(originAttrValueStr)){
                ...
                attr.value = render_template(originAttrValueStr);
            }
        }
        ...
        if(regex_check.test(originText)) {
            ele.innerHTML = render_template(originText)
