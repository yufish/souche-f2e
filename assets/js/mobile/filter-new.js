    ...
    function makeBrands(brands) {
        ...
        for (var i = 0; i < brands.length; i++) {
            ...
            if (!hotBrands_g[b.code]) {
                otherBrandsStr += '<div data-code="'+ b.code+'" class="item col-1-4"><div class="brand-name">'+ b.enName+'</div></div>';
            }
        }
    ...
    $('#btn-select-brand').click(function () {
        ...
        if (!brandLoaded) {
            ...
            for (var i in hotBrands_g) {
                hotBrandsStr += '<div data-code = "' + i + '"class = "item col-1-4"><div class="brand-name">' + hotBrands_g[i] + ' </div></div>';
            }
