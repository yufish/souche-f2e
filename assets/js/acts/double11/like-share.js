define(function(){
    ...
    var ADS_TEXT = {
        ...
        miaosha: {
            ...
            suc: '#大搜车0元秒新车#首先，我想感谢CCTV、感谢MTV、感谢ChannelV，还要感谢我的车迷，感谢所有支持我的人，没有你们的支持没有今天的我，这辆【车辆名称】是属于你们的。$1'
        },
        // 点赞的结果
        like: {
            // 自己点赞
            // self貌似是关键字了...
            own: {
                1:"大搜车#点赞分享筹红包#今天走了狗屎运啊！点赞筹红包就筹了1分钱！是朋友的就赶紧给我上啊！考验亲情友情爱情各种情的时候到了！点赞即可$1！",
                50: "大搜车#点赞分享筹红包#还不错嘛！点一个赞就抵了$2元的购车红包。别嘴上说我是个好人，帮我筹红包才算数！点赞即可指定$1！",
                500: "大搜车#点赞分享筹红包#别问我挖掘机技术哪家强！我只知道点个赞就瞬间变了$2元购车红包！快来帮我点赞筹红包吧！点赞即可$1！",
                3333: "大搜车#点赞分享筹红包#好激动！动了一下手指就筹到了$2元的购车红包，同学们and老少爷们乡亲们，快快抬起你们的手指，帮我一起抢红包啊！点赞即可$1！"
            },
            // 帮别人点赞
            help: {
                1: '大搜车#点赞分享筹红包#俗话说：1分钱难倒英雄汉。俗话也说：差1分钱买不到车的人不能叫英雄汉。帮朋友赢了1分购车红包，你们说朋友请我吃鲍鱼好还是茶叶蛋好呢？想想就有点小激动呢！想让我朋友请客的，帮忙点赞即可$1',
                50: '大搜车#点赞分享筹红包#别看我平时不言不语，关键时刻给朋友点赞筹红包必须走起！$2元红包瞬间妥妥到手！你们是不是也帮我朋友一把，点赞即可$1！',
                500: '大搜车#点赞分享筹红包#我人这么好我会告诉你吗？平时我就是这么默默无闻的给朋友无私奉献。瞬间帮朋友筹集了$2元的购车红包！你们也给我朋友无私奉献吧，点赞即可$1!',
                3333: '大搜车#点赞分享筹红包#动了一下手指就帮朋友筹到了$2元的购车红包。怪就只怪自己平时人太帅/美、心太好，心灵又美手又巧。帅哥美女们赶快帮下我朋友，点赞即可$1！'
            }
        }
    };
    // 部分相同的文案
    ...
    var  _view = {
        renderPopup: function(carBox, type, result){
            ...
            if( type === 'miaosha' ){
                ...
                var text = '';
                if( returnCode === 1){
                    text = ADS_TEXT.miaosha['suc'].replace('$1', ACT_URL);
                }
                else{
                    text = DS_TEXT.miaosha['suc'].replace('$1', ACT_URL);
                }
            ...
            // 点赞结果展示和分享
                ...
                if( carBox.hasClass('help-getcar') ){
                    ...
                    text = ADS_TEXT.like.help[result.val].replace('$1', ACT_URL).replace('$2', result.val );
                }
                else{
                    $('.share-congrate').text( CONG_4_SELF );
                    text = ADS_TEXT.like.own[result.val].replace('$1', 'http://souche.com').replace('$2', result.val );
                }
                Ele.shareText.val( text );
            }

            _view.renderCommon(carBox);
        },
        renderCommon: function(carBox){
            // get and fill
            var car = {
