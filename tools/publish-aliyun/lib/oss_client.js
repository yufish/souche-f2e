...
OssClient.prototype.getHeaders = function(method, metas, ossParams) {
    ...
    headers['Authorization'] = this.getSign(method /* http request method */ , headers['content-Md5'], headers['content-type'], date /* date of now */ , metas /* oss metas headers */ , resource /* http request resource */ );
    return headers;
};
...
OssClient.prototype.doRequest = function(method, metas, ossParams, callback) {
    ...
    if (ossParams.dstFile) {
        ...
        wstream.on('finish', function() {
            callback(null, ossParams.dstFile)
        })
    }
...
OssClient.prototype.copyObject = function(bucket, dstObject, srcObject, callback) {
    ...
    var metas = {
        'x-oss-copy-source': '/' + bucket + '/' + srcObject
    };
