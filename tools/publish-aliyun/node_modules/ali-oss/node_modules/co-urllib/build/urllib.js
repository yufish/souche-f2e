...
function request(url, args) {
  var parsedUrl, method, port, _request, agent, options, sslNames, i, name, auth, body, isReadAction, contentType, length, enableGzip, acceptEncoding, r, req, res, reqId, err, _url, aborted, data, size, encoding, gzipLength;
  ...
  return wrapGenerator(function request$($ctx0) {
    ...
    case 52:
      ...
      return $ctx0.delegateYield(request(_url, args), "t1", 55);
    case 55:
